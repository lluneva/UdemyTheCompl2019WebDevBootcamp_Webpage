<section id="pricing" class="section-normal section-colored-bg ">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="pricing-column col-sm-12 col-md-6 col-lg-4">
        <div class="card">
          <div class="card-header"> lielās </div>
          <div class="card-body">
            <h2> 7 eur/kg </h2>
            <p> no 5cm diametrā</p>
      ...
      <div class=" pricing-column col-sm-12 col-md-12 col-lg-4">
        <div class="card">
          <div class="card-header"> mazās </div>
          <div class="card-body">
            <h2> 4 eur/kg </h2>
